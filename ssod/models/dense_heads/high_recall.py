...
class HighRecallHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(HighRecallHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def filter_scores_and_topk(scores, score_thr, topk, results=None):
        ...
        # score [9*w*h, 80] -> [len(vaild_mask[True])]
        scores = scores[valid_mask]
        # return nonzero index, [[i, j]]
        ...
        # result bbox_pred, priors [w*h*9, 4]
    ...
    def loss(self,
        ...
        # 5 levels -> featmap_size[w, h] -> anchor_list [w*h*9, 4]
        cls_reg_targets = self.get_targets(
            ...
            gt_logits_list=gt_logits,
            formal_stage=formal_stage,
            label_channels=label_channels)
        if cls_reg_targets is None:
            return None

        # label_weights_list -> list[tensor] -> [5, [1, w*h*9]]
        # bbox_targets_list -> [5, [1, w*h*9, 4]]
        ...
        # 对 label_weights_list 根据 gt_logit top1-top2 赋值
    ...
    def get_targets(self,
        ...
        if gt_logits_list is None:
            gt_logits_list = [None for _ in range(num_imgs)]
